import 'package:blabla_project/widgets/actions/bla_text_button.dart';
...
class RidePrefBar extends StatefulWidget {
  ...
  final VoidCallback onRidePrefPressed; // modify / re-define preference
  final VoidCallback onFilterPressed; // apply filter with some opts
...
/// Displays ride preferences summary (departure, arrival, date, passengers)
/// 
